...
%
% This function is used by the novifast model to spoof 'downloadData', massaging the example data that
% ships with the public NOVIFAST repository [1] into a structure compliant with qMRLab's guidelines [2].
%
% That is:
...
%   - Copy the reference* volume3DFSE_FitResults.mat to FitResults/FitResults.mat
%
%   (*) To update the reference FitResults, delete volume3DFSE_FitResults.mat, and run this function.
%   It will be re-generated by fitting the data with the current qMRLab's novifast implementation.
%
% References:
...
fitResultsPath = fullfile(fileparts(mfilename('fullpath')),'volume3DFSE_FitResults.mat');
...
if ~exist(fitResultsPath,'file')
    % Update reference FitResults for a new version of novifast
