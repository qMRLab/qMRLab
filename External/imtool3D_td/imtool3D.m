...
msg = {'imtool3D, written by Justin Solomon',...
       ...
       '',...
       'DRAWING ROI MASKS',...
       'To draw a new ROI without Mask data loaded:',...
       'i)  Select a new mask color (Label 1 to 5)',...
       'ii)  Prescribe your ROI',...
       'iii)  Right click on the ROI --> poly2mask',...

       'To draw a new ROI with Mask data (Label 1) loaded:',...
       'i)   Lock all the colors (lock symbol)',...
       'ii)  Select a new mask color (Label 2 to 5)',...
       'iii) Prescribe your ROI',...
       'iv)  Right click on the ROI --> poly2mask',...
       '',...
       'You can save the created mask(s) in *.nii or *.mat format',...
