function h = corr_normplot(x,y,XLabel,YLabel)
...
plot(xp,yp,'r','LineWidth',3); title(['Density histogram for ' XLabel],'Fontsize',16); 
ylabel('Freq.','FontSize',14); xlabel(XLabel,'FontSize',14)
...
title(['Density histogram for ' YLabel],'Fontsize',16); 
ylabel('Freq.','FontSize',14); xlabel(YLabel,'FontSize',14);
box on;set(gca,'FontSize',14)
drawnow
...
xlabel(XLabel,'FontSize',14); ylabel(YLabel,'FontSize',14); title('Bivariate histogram','Fontsize',16)
