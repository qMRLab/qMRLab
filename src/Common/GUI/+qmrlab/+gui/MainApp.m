...
%   See docs/adr/0001-gui-migration.md.
    ...
    methods (Access = private)
        ...
        function minmax_call(app, varargin)
        ...
        function norm_call(app, varargin)
            % Callback for the histogram edit box.
    ...
    methods (Access = private)
        ...
        function Histogram_Callback(app, event)
            ...
            h_slider_bin = uicontrol(f,'Style','slider',...
                ...
                'Callback',{@app.sl_call,{h_hist h_edit_bin}});
            h_edit_bin.Callback = {@app.ed_call,{h_hist h_slider_bin}};
            ...
            h_button_minmax = uicontrol(f,'Style','pushbutton',...
                ...
                'Callback',{@app.minmax_call,{h_hist h_edit_min h_edit_max data}});
            ...
            h_popup_norm = uicontrol(f,'Style','popupmenu',...
                ...
                'Callback',{@app.norm_call,{h_hist h_ylabel}});
        end
