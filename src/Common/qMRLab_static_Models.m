...
MethodList = {'charmed' 'dti' 'noddi' 'b0_dem' 'b1_dam' 'mt_ratio' 'mt_sat' 'qmt_bssfp' 'qmt_sirfse' 'qmt_spgr' 'denoising_mppca' 'noise_level' 'filter_map' 'qsm_sb' 'inversion_recovery' 'vfa_t1' 'mp2rage' 'mwf' 'mono_t2' 'CustomExample' 'mtv'};
