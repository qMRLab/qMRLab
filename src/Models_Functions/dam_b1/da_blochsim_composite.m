function [Msig,MLong]=da_blochsim_composite(alpha, B1, T1, T2, TE, TR, crushFlag, partialDephasingFlag, partialDephasing, df, Nex, inc, inversion_type)
