...
.. raw:: html
   ...
   <span class="comment">% =========================================================================</span>
   </pre><h2 >I- DESCRIPTION<a name="2"></a></h2><pre class="codeinput">qMRinfo(<span class="string">'denoising_mppca'</span>); <span class="comment">% Describe the model</span>
     ...
     References:
       ...
       Reference page for denoising_mppca
   
   </pre><h2 >II- MODEL PARAMETERS<a name="3"></a></h2><h2 >a- create object<a name="4"></a></h2><pre class="codeinput">Model = denoising_mppca;
   ...
   </pre><img src="_static/denoising_mppca_batch_01.png" vspace="5" hspace="5" style="width:488px;height:694px;" alt=""> <h2 >III- FIT EXPERIMENTAL DATASET<a name="6"></a></h2><h2 >a- load experimental data<a name="7"></a></h2><pre >         |- denoising_mppca object needs 2 data input(s) to be assigned:
            |-   Data4D
   ...
   ...done
   </pre><img src="_static/denoising_mppca_batch_02.png" vspace="5" hspace="5" style="width:403px;height:98px;" alt=""> <h2 >c- show fitting results<a name="9"></a></h2><pre >         |- Output map will be displayed.
   ...
   </pre><img src="_static/denoising_mppca_batch_03.png" vspace="5" hspace="5" style="width:560px;height:420px;" alt=""> <h2 >d- Save results<a name="10"></a></h2><pre >         |-  qMR maps are saved in NIFTI and in a structure FitResults.mat
   ...
   </pre><h2 >V- SIMULATIONS<a name="11"></a></h2><pre >   |- This section can be executed to run simulations for denoising_mppca.</pre><h2 >a- Single Voxel Curve<a name="12"></a></h2><pre >         |- Simulates Single Voxel curves:
