...
.. raw:: html
   ...
   </pre><img src="_static/mt_ratio_batch_01.png" vspace="5" hspace="5" style="width:488px;height:694px;" alt=""> <h2 >III- FIT EXPERIMENTAL DATASET<a name="6"></a></h2><h2 >a- load experimental data<a name="7"></a></h2><pre >         |- mt_ratio object needs 3 data input(s) to be assigned:
            |-   MTon
            |-   MToff
