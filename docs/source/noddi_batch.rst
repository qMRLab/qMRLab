...
.. raw:: html
   ...
   </pre><img src="_static/noddi_batch_01.png" vspace="5" hspace="5" style="width:569px;height:833px;" alt=""> <h2 id="6">III- FIT EXPERIMENTAL DATASET</h2><h2 id="7">a- load experimental data</h2><pre >         |- noddi object needs 2 data input(s) to be assigned:
            |-   DiffusionData
   ...
   </pre><img src="_static/noddi_batch_02.png" vspace="5" hspace="5" style="width:560px;height:420px;" alt=""> <img src="_static/noddi_batch_03.png" vspace="5" hspace="5" style="width:560px;height:420px;" alt=""> <h2 id="10">d- Save results</h2><pre >         |-  qMR maps are saved in NIFTI and in a structure FitResults.mat
   ...
   </pre><img src="_static/noddi_batch_04.png" vspace="5" hspace="5" style="width:560px;height:420px;" alt=""> <h2 id="13">b- Sensitivity Analysis</h2><pre >         |-    Simulates sensitivity to fitted parameters:
   ...
   </pre><img src="_static/noddi_batch_05.png" vspace="5" hspace="5" style="width:560px;height:420px;" alt=""> <p class="footer"><br ><a href="http://www.mathworks.com/products/matlab/">Published with MATLAB R2016b</a><br ></p></div>
