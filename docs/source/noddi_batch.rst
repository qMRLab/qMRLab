...
.. raw:: html
   ...
   <span class="comment">% =========================================================================</span>
   </pre><h2 >I- DESCRIPTION<a name="2"></a></h2><pre class="codeinput">qMRinfo(<span class="string">'noddi'</span>); <span class="comment">% Describe the model</span>
   ...
   </pre><h2 >II- MODEL PARAMETERS<a name="3"></a></h2><h2 >a- create object<a name="4"></a></h2><pre class="codeinput">Model = noddi;
   ...
   </pre><img src="_static/noddi_batch_01.png" vspace="5" hspace="5" style="width:488px;height:694px;" alt=""> <h2 >III- FIT EXPERIMENTAL DATASET<a name="6"></a></h2><h2 >a- load experimental data<a name="7"></a></h2><pre >         |- noddi object needs 2 data input(s) to be assigned:
            |-   DiffusionData
   ...
   </pre><img src="_static/noddi_batch_02.png" vspace="5" hspace="5" style="width:560px;height:420px;" alt=""> <img src="_static/noddi_batch_03.png" vspace="5" hspace="5" style="width:560px;height:420px;" alt=""> <h2 >d- Save results<a name="10"></a></h2><pre >         |-  qMR maps are saved in NIFTI and in a structure FitResults.mat
   ...
   </pre><h2 >V- SIMULATIONS<a name="11"></a></h2><pre >   |- This section can be executed to run simulations for noddi.</pre><h2 >a- Single Voxel Curve<a name="12"></a></h2><pre >         |- Simulates Single Voxel curves:
   ...
   </pre><img src="_static/noddi_batch_04.png" vspace="5" hspace="5" style="width:560px;height:420px;" alt=""> <h2 >b- Sensitivity Analysis<a name="13"></a></h2><pre >         |-    Simulates sensitivity to fitted parameters:
   ...
   </pre><img src="_static/noddi_batch_05.png" vspace="5" hspace="5" style="width:560px;height:420px;" alt=""> <p class="footer"><br ><a href="http://www.mathworks.com/products/matlab/">Published with MATLAB R2015b</a><br ></p></div>
