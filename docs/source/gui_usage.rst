...
where *Modelname* is nay of the available models (e.g. in this example *help SPGR*)
...
5.	Define or load the appropriate protocol in the Options panel (see section 5.2 for details).
6.	Define your fitting options in the Options panel (see section 5.3 for details).
...
3.	Using the *Options* panel, define or load your simulation parameters (see section 5.1).
4.	Using the *Options* panel, define or load the protocol you wish to use (see section 5.2).
5.	Using the *Options* panel, define or load your initial fitting options (see section 5.3).
...
3.	Using the *Options* panel, define or load your simulation parameters (see section 5.1). The parameters defined here are used as the fixed parameters values as one parameter at a time is systematically varied during the simulation process.
4.	Using the *Options* panel, define or load the protocol you wish to use (see section 5.2).
5.	Using the *Options* panel, define or load your fitting options (see section 5.3).
...
3. Using the *Options* panel, define or load your simulation parameters (see section 5.1). The parameters defined here are used as the fixed parameters values for parameters that are not selected to be varied.
4. Using the *Options* panel, define or load the protocol you wish to use (see section 5.2).
5. Using the *Options* panel, define or load your fitting options (see section 5.3).
