...
for ii = 1:length(MethodList)
    ...
    if Model.voxelwise
        ...
        disp('- stage: Test');
        disp(['script: travis_wait 30 octave --no-gui --eval "startup;cd(' char(39) '/home/travis/build/neuropoly/qMRLab/Test/MoxUnitCompatible' char(39) ');res=moxunit_runtests(' char(39) writeName ');exit(~res);"']);
    end
