function test_suite=SimTest_mono_t2_test
...
function test_Sim
disp('===========================================')
disp('Running simulation test for mono_t2');
disp('testing Simulation Single Voxel Curve...');


Model = str2func('mono_t2'); Model = Model();
savedModel_fname = fullfile(fileparts(which('qMRLab')),'Test','MoxUnitCompatible','static_savedModelsforRetrocompatibility',['mono_t2.qmrlab.mat']);
